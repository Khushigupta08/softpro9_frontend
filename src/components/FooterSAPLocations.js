// File: FooterSAPLocations.js
// Save this in: src/components/FooterSAPLocations.js
...
export default function FooterSAPLocations() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-gray-400">
                        <li>
                            <Link to="/policy" onClick={handleLinkClick} className="hover:text-white transition-colors duration-300 text-sm">
                                Privacy Policy
                            </Link>
                        </li>
                        <li>
                            <Link to="/conditions" onClick={handleLinkClick} className="hover:text-white transition-colors duration-300 text-sm">
                                Terms & Conditions
                            </Link>
                        </li>
                        <li>
                            <Link to="/refund" onClick={handleLinkClick} className="hover:text-white transition-colors duration-300 text-sm">
                                Refund Policy
                            </Link>
                        </li>
                        <li>
                            <Link to="/faq" onClick={handleLinkClick} className="hover:text-white transition-colors duration-300 text-sm">
                                FAQ
                            </Link>
                        </li>
                    </ul>
            ...
            {/* SAP TRAINING LOCATIONS SECTION */}
            <div className="mt-12 pt-8 border-t border-gray-800">
                <h4 className="font-semibold mb-4 text-lg">Our Training Locations</h4>
                <div className="text-gray-400 text-sm leading-relaxed flex flex-wrap">
                    <Link to="/location/sap-training-bangalore" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Bangalore
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-berlin" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Berlin
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-dubai" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Dubai
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-mangalore" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Mangalore
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-mysore" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Mysore
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-qatar" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Qatar Doha
                    </Link>
                    <span className="mx-2">|</span>
                    <Link to="/location/sap-training-singapore" onClick={handleLinkClick} className="hover:text-white transition-colors">
                        SAP Training in Singapore
                    </Link>
