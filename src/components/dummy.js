            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">
                        Choose Your Digital Marketing Plan
                    </h2>
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Transparent pricing with no hidden fees. Scale your business with our comprehensive digital marketing solutions.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 hover:shadow-xl hover:scale-105 hover:border-gray-300 transition-all duration-300 cursor-pointer group">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">Best for small businesses & startups exploring digital growth.</p>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">SEO Optimization (On-Page & Off-Page)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Social Media Setup & Management (2 Platforms)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Google My Business Optimization</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Basic Content Marketing (4 posts/month)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                        ...
                        {/* CTA Button */}
                        <button className="w-full bg-gray-900 text-white py-3 px-6 rounded-xl font-semibold hover:bg-gray-800 hover:scale-105 transform transition-all duration-300 shadow-md hover:shadow-lg">
                            Get Started
                        </button>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-blue-500 relative transform scale-105 hover:shadow-2xl hover:scale-110 transition-all duration-300 cursor-pointer group">
                        ...
                        <div className="text-center mb-6 mt-4">
                            ...
                            <p className="text-gray-600 leading-relaxed">Ideal for growing businesses aiming for consistent lead generation.</p>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Advanced SEO (Keyword Strategy + Backlinking)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Social Media Management (4 Platforms)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Paid Ad Campaigns (Google Ads / Meta Ads)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Email & WhatsApp Marketing Automation</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">AI-Powered Content Creation (Blogs, Infographics)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                            ...
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Bi-Weekly Analytics & Consultation</span>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 hover:shadow-xl hover:scale-105 hover:border-gray-300 transition-all duration-300 cursor-pointer group">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">For corporates & enterprises demanding 360° marketing with AI.</p>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Enterprise SEO + Competitor Analysis</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Full Social Media Management (All Major Platforms)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Multi-Channel Paid Ads (Google, Meta, LinkedIn)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Marketing Automation & CRM Integration</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">AI-Driven Campaigns & Predictive Analytics</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Dedicated Content Marketing (Blogs, Videos, Infographics)</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">24/7 Support & Monthly Strategy Workshops</span>
                            </div>
                            <div className="flex items-start space-x-3">
                                <CheckIcon />
                                <span className="text-gray-700">Customized Dashboard & KPI Tracking</span>
                            </div>
                        </div>
